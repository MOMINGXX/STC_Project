     ...
     //UARTSendByte(dat);//串口识别码（十六进制）
		 ...
		 {	
			 ...
			 switch(dat)		   /*对结果执行相关操作,客户可删除Printcom 串口输出语句替换为其他需要控制的代码*/
			  {
				  case 1:			/*命令“测试”*/
						PrintCom("“播放音乐”命令识别成功\r\n"); /*text.....*/
						PrintCom("PLAYMUSIC#");
													 break;
					case 2:	 /*命令“全开”*/
						PrintCom("“继续播放”命令识别成功\r\n"); /*text.....*/
						PrintCom("PLAYON#");
														break;
					case 3:		/*命令“复位”*/				
						PrintCom("“随机播放”命令识别成功\r\n"); /*text.....*/
						PrintCom("RANDOMPLAY#");
													break;
					case 4:		/*命令“复位”*/				
						PrintCom("“停止播放”命令识别成功\r\n"); /*text.....*/
						PrintCom("STOPMUSIC#");
													break;
					case 5:		/*命令“复位”*/				
						PrintCom("“暂停”命令识别成功\r\n"); /*text.....*/
						PrintCom("SUSPENDMUSIC#");
													break;
					case 6:		/*命令“复位”*/				
						PrintCom("“下一首”命令识别成功\r\n"); /*text.....*/
						PrintCom("NEXTSONG#");
					...
					case 7:		/*命令“复位”*/				
						...
						PrintCom("LASTSONG#");
					case 8:		/*命令“复位”*/				
						PrintCom("“增大音量”命令识别成功\r\n"); /*text.....*/
						PrintCom("ADDVOLUME#");
													break;		
					case 9:	 /*命令“全开”*/
						PrintCom("“减小音量”命令识别成功\r\n"); /*text.....*/
						PrintCom("REDUCEVOLUME#");
														break;
